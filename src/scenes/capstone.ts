import { type SceneSpec, ORANGE, RED, BLUE, GREEN, TEAL, PURPLE } from 'flow-engine'
...
export const capstone: SceneSpec = {
  ...
  canvas: { width: 1960, height: 1200 },
  grid: { cols: 3, rows: [0.5, 1.05, 1.05], gap: 0.32, padding: 0.35 },
  nodes: [
