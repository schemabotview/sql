import { type SceneSpec, GREEN, BLUE, ORANGE, PURPLE } from 'flow-engine'
...
export const enginePath: SceneSpec = {
  ...
  canvas: { width: 1900, height: 1320 },
  grid: { cols: 1, rows: [0.95, 0.8, 0.56, 0.68, 0.6], gap: 0.3, padding: 0.35 },
  nodes: [
