import { type SceneSpec, TEAL, GRAY, BLUE, PURPLE, GREEN } from 'flow-engine'
...
export const normalization: SceneSpec = {
  ...
  canvas: { width: 1620, height: 1120 },
  grid: { cols: [1, 1, 1, 1], rows: [1.4, 0.95, 0.95], gap: 0.35, padding: 0.45 },
  nodes: [
